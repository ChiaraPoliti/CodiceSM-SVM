...
def SVM_Soft_Margin(C: int, dimensions: List, observations: List, X: NDArray[np.float64], y: NDArray[np.int_]):
    """Funzione per calcolare l'iperpiano ottimo con margine geometrico massimo con Soft-Margin SVM.
