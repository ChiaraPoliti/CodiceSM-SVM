...
def SVM_Soft_Margin_Gurobi(C: int, dimensions: List, observations: List, X: NDArray[np.float64], y: NDArray[np.int_]):
    """Funzione per calcolare l'iperpiano ottimo con margine geometrico massimo con Soft-Margin SVM con solver Gurobi.
    ...
    Soft_Margin_SVM_model.solve(solver=GUROBI())
