...
from SVM_Soft_Margin import SVM_Soft_Margin

"""Funzione che sfrutta SM-SVM (Cplex) per classificare alcuni dati su 6 database e ritorna i relativi file excel con i risultati delle previsioni"""
    ...
    for C in c_values:
        for training_percentage in training_percentages:
            ...
            for try_number in range(number_of_tries):
                ...
                a, b, z = SVM_Soft_Margin(C, dimensions, observations_training, X_train, y_train)
